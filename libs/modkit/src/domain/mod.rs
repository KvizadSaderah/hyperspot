...
impl<K: DomainSafe, V: DomainSafe> DomainSafe for HashMap<K, V> {}
impl<K: DomainSafe, V: DomainSafe> DomainSafe for BTreeMap<K, V> {}
impl<T: DomainSafe> DomainSafe for HashSet<T> {}
...
mod tests {
    ...
    fn _assert_domain_safe<T: DomainSafe>() {}

    #[test]
    fn test_primitives_are_domain_safe() {
        _assert_domain_safe::<bool>();
        _assert_domain_safe::<i32>();
        _assert_domain_safe::<String>();
        _assert_domain_safe::<f64>();
    }

    #[test]
    fn test_collections_are_domain_safe() {
        _assert_domain_safe::<Vec<String>>();
        _assert_domain_safe::<Option<i32>>();
        _assert_domain_safe::<HashMap<String, i32>>();
    }

    #[test]
    fn test_third_party_types_are_domain_safe() {
        _assert_domain_safe::<Uuid>();
        _assert_domain_safe::<serde_json::Value>();
    }

    #[test]
    fn test_nested_types_are_domain_safe() {
        _assert_domain_safe::<Vec<Option<Uuid>>>();
        _assert_domain_safe::<HashMap<String, Vec<i32>>>();
        _assert_domain_safe::<Result<String, String>>();
    }
}
